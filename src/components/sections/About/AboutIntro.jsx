  ...
  return (
    <article className="rounded-2xl border border-white/10 bg-white/[0.035] p-6 shadow-[0_20px_60px_rgba(0,20,75,0.18)] sm:p-7 lg:p-8">
      ...
      <p className="mt-5 text-xl leading-[1.45] text-white sm:text-2xl">
        I&apos;m an Artificial Intelligence Engineer &amp; Full-Stack Web Developer focused on building intelligent systems and modern software experiences.
      </p>

      <p className="mt-5 max-w-[34rem] text-sm leading-6 text-zinc-400 sm:text-base">
        My work spans Artificial Intelligence, Machine Learning, Computer Vision, Full-Stack Development, and Robotics. I enjoy turning ideas into scalable, reliable, and impactful solutions that solve real-world problems.
      </p>
      ...
      <div className="mt-6 border-t border-white/10 pt-4 sm:mt-7">
        ...
        <div className="mt-3 grid grid-cols-3 text-center text-xs font-medium text-zinc-300">
          <span>AI</span>
          <span className="border-x border-white/10">CV</span>
          <span>WEB</span>
        </div>
      </div>
    </article>
