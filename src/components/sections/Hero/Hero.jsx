  ...
  return (
    <section id="home" className="relative">
      <Container className="relative z-10">
        <div className="grid gap-12 py-12 xl:min-h-[calc(100svh-var(--header-height))] xl:grid-cols-[minmax(0,620px)_minmax(460px,1fr)] xl:items-center xl:gap-[clamp(3rem,7vw,6rem)] xl:py-0">
          <HeroContent />
          <HeroImage />
        </div>
      </Container>
